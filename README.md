...
## ⚙️ How It Works
1. The user interacts with a grid-based interface  
2. Electrical components are placed using mouse clicks  
3. The system validates placement rules  
4. The A\* algorithm calculates the shortest wiring path  
5. The wiring is visually displayed on the grid  
